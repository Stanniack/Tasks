package com.example.mateus.mytasks.repository;

import android.content.Context;


import com.example.mateus.mytasks.NetworkUtils.NetworkUtils;
import com.example.mateus.mytasks.constants.TaskConstants;
import com.example.mateus.mytasks.entities.APIResponse;
import com.example.mateus.mytasks.entities.FullParameters;
import com.example.mateus.mytasks.infra.InternetNotAvailableException;
...
public class ExternalRepository {
    ...
    public APIResponse execute(FullParameters fullParameters) throws InternetNotAvailableException {
        ...
        if (!NetworkUtils.estaConectado(this.mContext)) {
        ...
        try {
            ...
            if (fullParameters.method == TaskConstants.OPERATION_METHOD.GET)
                url = new URL(fullParameters.url + getQuery(fullParameters.params, fullParameters.method));
            else
            ...
            if (!fullParameters.method.equals(TaskConstants.OPERATION_METHOD.GET)) {
                ...
                String query = getQuery(fullParameters.params, fullParameters.method);
